...
activePromo = localStorage.getItem('promo') ? localStorage.getItem('promo') : null;
...
if (activePromo){
    ...
    document.querySelector('.have-promo span').innerText = activePromo;
}
...
function submitQuiz() {
    ...
    if (score >= 3) {
        ...
        localStorage.setItem('promo', randomElement.name);
    }
    if (score >= 1) {
        setTimeout(function() {
            location.reload();
